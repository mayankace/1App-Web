...
const CategoryManagement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let res;
            if (editingId) {
                res = await adminApi.updateSubCategory(editingId, { name: subcategoryName, categoryId: selectedCategoryId });
                if (res.success) toast.success('SubCategory updated!');
            } else {
                res = await adminApi.createSubCategory(subcategoryName, selectedCategoryId);
                        ...
                        <table className="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                {subcategories.length === 0 && (
                                    <tr><td colSpan="4" className="text-center py-5 text-muted">No sub-categories found. Create your first sub-category!</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
